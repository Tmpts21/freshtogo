                            ...
                            <table class="mt-5 text-center w-full text-sm text-left text-gray-500 dark:text-gray-800 border mx-auto ">
                                ...
                                <tbody class="mx-auto">
                                    ...
                                    <td class="px-2 py-1 border border-2 " >
                                        ...
                                        <Link v-if="order.status == 'pending' ||  order.status == 'assigned' " :href="route('customer.cancel_order' , {orderId : order.id , status : order.status })"  class="font-bold text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800 mr-2 "  v-html="'Cancel'" />
                                    </td>
