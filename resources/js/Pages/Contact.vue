...
<template>
 ...
 <nav class="bg-lime-400 shadow shadow-lg ">
    ...
    <div class="relative flex items-top justify-center   sm:items-center sm:pt-0">
        ...
        <div class="mt-2 mx-5 max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <div class="flex justify-center">
                    ...
                    <div class="flex justify-center ">
                        <div>
                            <p><i class="fa-brands fa-facebook mr-2 text-2xl p-1"></i></p>
                        </div>
                         <div>
                            <p><i class="fa-brands fa-twitter mr-2 text-2xl p-1"></i></p>
                        </div>
                         <div>
                            <p><i class="fa-brands fa-instagram mr-2 text-2xl p-1 mb-2 "></i></p>
                        </div>
