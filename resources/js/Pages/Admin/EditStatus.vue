...
export default {
  ...
  setup (props) {
    ...
    function submit() { 
         Inertia.post('/admin/users/edit/status', form)
    }
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 flex flex-col justify-center items-center">
                        ...
                        <form @submit.prevent="submit()"  class="bg-white rounded px-8 pt-6 pb-8 mb-4">
                            ...
                            <div class="mb-4 ">
                              <label for="status" class="font-bold block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Update User Status</label>
