                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="relative overflow-x-auto sm:rounded-lg font-bold">
                            ...
                            <Link  :href="route('admin.create_user')"  class="float-right text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" v-html="'Add new User '"/>
                            <table class="text-center w-full text-sm text-left text-gray-500 dark:text-gray-800 border ">
                                ...
                                <tbody>
                                    ...
                                    <td class=" border boder-2 px-5 py-4" >
                                        <Link  :href="route('admin.view_user' , {id : user.id})"  class=" border boder-2 font-bold text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800"  v-html="'View 👀'" />
                                        <a v-if="user.role === 'driver'" target="_blank"  :href="'https://www.google.com/maps/dir/?q=' + user.lat + ',' + user.lon"  class=" border boder-2 font-bold text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800"> 🗺 View Driver Location </a>
